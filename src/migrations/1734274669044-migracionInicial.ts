...
export class MigracionInicial1734274669044 implements MigrationInterface {
    name = 'MigracionInicial1734274669044'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "advertisement" ("id" SERIAL NOT NULL, "price" numeric(10,2) NOT NULL, "status" "public"."advertisement_status_enum" NOT NULL, "propertyType" "public"."advertisement_propertytype_enum" NOT NULL, "propertyId" integer, CONSTRAINT "PK_c8486834e5ef704ec05b7564d89" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "property" ("id" SERIAL NOT NULL, "address" character varying NOT NULL, "area" integer NOT NULL, "ownerName" character varying NOT NULL, "sector" "public"."property_sector_enum" NOT NULL, "coordinates" geometry(Point,4326) NOT NULL, CONSTRAINT "PK_d80743e6191258a5003d5843b4f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_fb48a701ea1ec50abb84a81a74" ON "property" ("area") `);
        await queryRunner.query(`CREATE TABLE "transaction" ("id" SERIAL NOT NULL, "address" character varying NOT NULL, "price" numeric NOT NULL, "date" date NOT NULL, "type" "public"."transaction_type_enum" NOT NULL, "propertyId" integer, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`);
